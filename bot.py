...
# =====================================================  LOAD MODELS ==================================================
dtc , le  = pk.load(open('C:\\Users\\bodepu chandu ram\\OneDrive\\Pictures\\Documents\\HealthCare_ChatBot-master\\chatbot_modelsave','rb'))
model,second_le  = pk.load(open('C:\\Users\\bodepu chandu ram\\OneDrive\\Pictures\\Documents\\HealthCare_ChatBot-master\\chatbot_model','rb'))
#ners = pk.load(open('C:\\Users\\AJMAL\\Downloads\\HealthCare_ChatBot-master\\HealthCare_ChatBot-master\\newsave_model','rb'))

# Load NN Model 
FILE = "C:\\Users\\bodepu chandu ram\\OneDrive\\Pictures\\Documents\\HealthCare_ChatBot-master\\data.pth"
