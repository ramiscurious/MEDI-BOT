...
class ChatApplication:
    ...
    def _get_name(self):
        self.window.title("Welcome to Medi Chatbot")
        ...
        about.add_command(label="Develpoers", command=lambda: self.msg_showinfo(f"Bot Develpoers ",f"Project Mentor - <mentor name> \n\nGroup number - 01 \n\nGroup Members \n\n1. <GM1> \n2. <GM1> \n3. <GM1> \n"),font="bold")
